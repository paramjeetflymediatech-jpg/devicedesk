                ...
                return (
                  <tr key={l.id} style={{ borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                    <td style={{ padding: "14px 16px", fontWeight: 600 }}>
                      <Link href={`/employee-dashboard/hr-leaves/${empSlug}`} style={{ color: "var(--text-primary, #f8fafc)", textDecoration: "none" }}>
                        {l.employeeName || l.employeeId}
                      </Link>
                    </td>
                    <td style={{ padding: "14px 16px" }}>
                      <Link
                        href={`/employee-dashboard/hr-leaves/${empSlug}`}
                    ...
                    <td style={{ padding: "14px 16px", textAlign: "right" }}>
                      <Link href={`/employee-dashboard/hr-leaves/${empSlug}`} className="btn-action start" style={{ padding: "4px 10px", fontSize: "0.75rem", textDecoration: "none" }}>
                        View &rarr;
                      </Link>
                    </td>
                  </tr>
